...
from ELSEVIER, License number 6100600070814)[6]_
...
(Reproduced with permission from WOLTERS KLUWER HEALTH. License number 6100601078993)[24]_
...
surrounding brain parenchyma (gliosis). (Licensed under CC BY 4.0)[9]_
...
_Figure 3.4a: The swirl sign.[9]*_

<img alt='Diagram of the Eye' src='/figures/3_4_b.png' />
_Figure 3.4b: The black hole sign.[9]*_
...
_Figure 3.4c: The blend sign.[9]*_

<img alt='Diagram of the Eye' src='/figures/3_4_d.png' />
_Figure 3.4d: The island sign.[9]*_
...
_Figure 3.4e: The satellite sign.[9]*_
...
_Figure 3.4f: The spot sign. (white arrows)[9]*_
